...
def process_lr_vi_day(task):
    ...
    VIsresults_daily['gcc'] = VIcon.gcc
...
# 3FLD parameters 
wl3fld = [757, 760, 770] # [758,760.6,770.7] # from matlab SIFnFLD.m # [752, 762, 775]
widths = [1, 1, 1] # [1.073,1.,0.699] # [3.5, 2, 5]
# iFLD parameters
...
if __name__ == "__main__":
    ...
    for Year in [2022, 2023, 2024, 2025]: # 2022, 2023, 2024, 2025, 2026
